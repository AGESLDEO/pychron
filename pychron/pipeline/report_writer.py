    ...
    def traits_view(self):
        ...
        for at, name in (
            ...
            grp = VGroup(
                ...
                UItem(
                    "{}_series_options_controller".format(at),
                    style="custom",
        ...
        sog = UItem(
            "cocktails_series_options_controller",
            style="custom",
        ...
        iog = UItem(
            "cocktails_ideogram_options_controller",
            style="custom",
            enabled_when="cocktails_enabled",
            editor=InstanceEditor(view=view(name)),
            label="Ideogram",
        ...
        cocktail_grp = VGroup(
            Item("cocktails_enabled", label="Enabled"),
        ...
        sog = UItem(
            "unknowns_series_options_controller",
            style="custom",
        ...
        iog = UItem(
            "unknowns_ideogram_options_controller",
            style="custom",
            enabled_when="unknowns_enabled",
            editor=InstanceEditor(view=view(name)),
            label="Ideogram",
        ...
        unk_grp = VGroup(
            Item("unknowns_enabled", label="Enabled"),
...
class ReportWriter(BasePDFTableWriter):
    ...
    def _make_ideogram(self, analysis_type, ag):
        opt = getattr(
            self.options, "{}s_ideogram_options_manager".format(analysis_type)
        ).selected_options
